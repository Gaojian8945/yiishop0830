	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
            ...
            <?php foreach ($goods as $good):?>
				<tr id="<?=$good['id']?>">
					<td class="col1"><a href="<?=\yii\helpers\Url::to(['/goods/goods-info','id'=>$good['id']]);?>"><img src="<?=$good['logo']?>" alt="" /></a>  <strong><a href="<?=\yii\helpers\Url::to(['/goods/goods-info','id'=>$good['id']]);?>"><?=$good['name']?></a></strong></td>
