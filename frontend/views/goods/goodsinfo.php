...
<body>
	...
	<!-- 头部 start -->
    <?php include_once Yii::getAlias('@app/views/comment/header.php')?>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$goods->images[0]->path?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goods->images[0]->path.'?imageView2/1/w/350/h/350'?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($goods->images as $k => $v):?>
								<li class="<?=$k==0?"cur":""?>">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?=date('Y-m-s H:s:m',$goods->inputtime)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to(['/goods/cook'])?>" method="get" class="choose">
						<ul>
