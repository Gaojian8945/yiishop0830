    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['/goods/goods-info','id'=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['/goods/goods-info','id'=>$good->id])?>"><?=$good->name?></a></dt>
                        <dd><strong>￥<?=$good->shop_price?></strong></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['/goods/goods-info','id'=>$good->id])?>"><em>已有10人评价</em></a></dt>
                    </dl>
                </li>
                <?php endforeach;?>
